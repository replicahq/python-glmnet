...
Python versions. The package itself is not otherwise maintained; see `glmstar <https://github.com/jonathan-taylor/glmstar>`_ for a more recent library based on a newer version of the underlying ``glmnet`` package.
